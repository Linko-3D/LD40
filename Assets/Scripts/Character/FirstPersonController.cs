...
namespace UnityStandardAssets.Characters.FirstPerson.PrincessCake
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private AudioClip m_CurrFootstepLight;
        private AudioClip m_CurrFootstepChubby;
        private AudioClip m_CurrFootstepFat;
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded)
            {
                ...
                if (m_Jump)
                {
                    m_MoveDir.y = m_JumpSpeed * (1 - (Game.Instance.PrincessCake.Model.Weight / (float)Game.Instance.PrincessCake.Settings.MaxWeight) + 0.2f);
                    PlayJumpSound();
                    m_Jump = false;
                    m_Jumping = true;
                }
        ...
        private void PlayFootstep(AudioClip[] stepClips, ref AudioClip m_Curr) {
            // pick & play a random footstep sound from the array,
            // excluding sound at index 0
            ...
            m_AudioSource.TryPlaySFX(m_Curr);
